# Delaware Lighthouse Design System sources

Retrieved 2026-08-19. Recheck before every new production adoption.

## Authoritative sources

- https://gic.delaware.gov/lighthouse-design-system/
- https://lighthouse.delaware.gov/
...
- The official GIC GitHub account hosts an unlinked, undescribed repository (`Delaware-GIC/LH`) containing compiled Lighthouse CSS; it is not referenced by the documentation, so it is not treated as an official delivery path — recheck its status periodically.
