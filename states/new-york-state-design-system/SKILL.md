...
description: Builds New York State interfaces with official Lit web components, styles, tokens, Angular directives, accessibility guidance, and theming. Use for New York State products, not New York City or other municipal brands, and select framework-neutral or Angular integration deliberately.
---
