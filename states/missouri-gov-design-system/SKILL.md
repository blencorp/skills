---
name: missouri-gov-design-system
description: Builds Missouri state pages from the official MO.gov v5 hosted assets, Bootstrap-oriented templates, and component examples. Use for Missouri government sites that accept hosted, unversioned delivery; no package or public source repository was verified.
---

# Missouri.gov Design System

> Adoption gate: Conditional; public templates and assets exist, but there is no versioned package or verified source repository.
...
- **Scope:** Missouri state-government websites using the MO.gov v5 template/assets.
- **Delivery:** Hosted customized Bootstrap assets, page templates, and component examples.
