---
name: montana-gov-template
description: Builds Montana state websites with the official Montana.gov hosted template CSS, JavaScript, header, footer, background, and required wrapper markup. Use for authorized Montana sites that accept the hosted Template Loader model.
---
...
- **Scope:** Montana state websites participating in the SITSD template service.
- **Delivery:** SITSD-hosted CSS/JavaScript and injected header/footer assets.
