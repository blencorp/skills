...
description: Maintains or extends FEC.gov interfaces with the official Federal Election Commission Pattern Library source and documentation. Use for FEC product work that already participates in the FEC CMS asset pipeline; do not treat it as a portable government-wide package.
---

# FEC Pattern Library

> Adoption gate: Conditional; active public source and documentation, but product-specific and not distributed as an independent package.
