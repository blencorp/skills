---
name: cdc-dibbs-design-system
description: Maintains CDC Data Integration Building Blocks interfaces from the official DIBBs Design System source, Sass configuration, overrides, and example markup. Use only for DIBBs product work or an explicitly approved derivative; no independent package is published.
---

# CDC DIBBs Design System
...
- **Release:** Public official source repository; there is no standalone package or complete public documentation site.
