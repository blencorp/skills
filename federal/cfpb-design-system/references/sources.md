...
- Release state: Conditional; active official core and React repositories, but upstream describes both as work in progress — the React repository's status note says interfaces will change and things will break.
