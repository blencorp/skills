# Medicare.gov Design System implementation
...
- Package snapshot: `@cmsgov/ds-medicare-gov@18.1.0`, `@cmsgov/design-system@18.1.0`
...
- Load the Medicare.gov child theme and use CMS core for shared component behavior.
- Keep child and core package versions compatible and normally aligned.
- Do not reproduce Medicare branding with ad hoc overrides.

## Build and verify

Use the component and pattern documentation at https://design.cms.gov/?theme=medicare (installation and usage: https://design.cms.gov/getting-started/for-developers/?theme=medicare); the child-design-systems overview page describes the model but carries no component APIs. Copy exact current API names and markup from the themed documentation; if the requested pattern is absent, say that the upstream system does not document it and propose a clearly labeled custom extension.
