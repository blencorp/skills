---
name: login-gov-design-system
description: Builds Login.gov interfaces with the official Identity Design System and its USWDS-compatible Sass, JavaScript, assets, and Login.gov-specific patterns. Use for Login.gov-owned authentication and identity experiences, not generic federal sign-in pages.
---

# Login.gov Identity Design System
