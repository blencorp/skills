...
- Release state: Ready; actively maintained official web and mobile libraries. The native-mobile packages are still pre-1.0 (`mobile-component-library` 0.x, `mobile-tokens` 0.x) although upstream presents them as the consumer offering — pin versions and watch releases on the mobile path.
